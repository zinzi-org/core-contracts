...
contract Proposal is ERC165, IERC721, IERC721Metadata {
    ...
    address public memberNFTContract;

    constructor(address __memberNFTContract) {
        memberNFTContract = __memberNFTContract;
    }

    function mintTo(address who) public {
        _safeMint(who, count);
        count += 1;
    }
        ...
        returns (string memory)
    {
        ...
        return
            string.concat(
                "https://www.labor.land/proposal/",
                Strings.toString(tokenId)
            );
    }

    function approve(address to, uint256 tokenId) public virtual override {
        address tokeOwner = Proposal.ownerOf(tokenId);
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Proposal.ownerOf(tokenId), to, tokenId);
    }
